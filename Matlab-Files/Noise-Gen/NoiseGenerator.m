...
image_width = 224;
image_height = 224;
image_sample_count = 25000;
output_dir_n = fullfile(pwd(), 'Images-25000', 'Normal');
output_dir_a = fullfile(pwd(), 'Images-25000', 'Anomaly-A');
output_dir_b = fullfile(pwd(), 'Images-25000', 'Anomaly-B');
output_dir_c = fullfile(pwd(), 'Images-25000', 'Anomaly-C');
output_dir_d = fullfile(pwd(), 'Images-25000', 'Anomaly-D');
...
disp('Generated ' + string(samples) + ' samples of normal operation.')
